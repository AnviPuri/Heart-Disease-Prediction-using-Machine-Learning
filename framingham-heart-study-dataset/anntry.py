# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 11:31:11 2019
...
inp=int(input("Enter 1 if you want to train model."))
if  (inp==1):
...
for train, test in kfold.split(X, Y):
  # create model
	model = Sequential()
	model.add(Dense(activation="relu", input_dim=14, units=8, kernel_initializer="uniform"))
