...
from PyQt5.QtWidgets import QWidget, QApplication, QLabel, QComboBox, QLineEdit, QCheckBox, QRadioButton, QPushButton, \
...
class Window(QWidget):
    ...
    def submit_clicked(self):
        ...
        if self.wd_current_smoker.isChecked():
            sample['col2'] = [1]
            if self.wd_cigs_per_day != '':
                sample['col3'] = [self.wd_cigs_per_day.text()]
            else:
                print('enter number of cigarettes consumed per day')
        else:
            sample['col2'] = [0]
